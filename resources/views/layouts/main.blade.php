            ...
            <ul class="list-unstyled topnav-menu float-end mb-0">
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="{{ url('dashboard/assets/images/users/user-1.jpg') }}" alt="user-image" class="rounded-circle">
    ...
    <div class="left-side-menu">
        ...
        <div class="h-100" data-simplebar>
            ...
            <div class="user-box text-center">
                <img src="{{ url('dashboard/assets/images/users/user-1.jpg') }}" alt="user-img" title="Mat Helme"
    ...
    <div class="content-page">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <script>document.write(new Date().getFullYear())</script> &copy; Company Profile by <a href="">EdsonTech</a>
                    </div>
                    <div class="col-md-6">
