    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Manage Person In Charge</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">PIC Data</h4>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="standard-modalLabel">Banner Form</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="avatar" name="avatar" placeholder="Select Avatar">
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        $(window).on('load', function () {
            ...
            $('#submit_form').click(function () {
                ...
                if(aksi=="input"){
                    ...
                    $.ajax({
                        url: "{{ url('/manage-pic/edit') }}/"+id_data,
                        type: "post",
                        data: new FormData($('#form_input')[0]),
                        async: false,
                        cache: false,
            ...
            $('#datatable tbody').on('click', '#delete', function (e) {
                ...
                Swal.fire({
                    ...
                    e.value
                        ?
                        $.ajax({
                            url: "{{ url('/manage-pic/delete/') }}/" + data.id,
                            type: "post",
                            data: {
                                "_token": "{{ csrf_token() }}",
                            },
