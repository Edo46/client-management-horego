...
use App\Http\Controllers\AssignedOrganisationController;
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'manage-organisation'], function () {
        ...
        Route::get('/list', [OrganisationController::class, 'list']);
...
Route::group(['middleware' => ['role:super_admin', 'auth']], function () {
    ...
    Route::group(['prefix' => 'manage-assigned'], function () {
        Route::get('/data', [AssignedOrganisationController::class, 'ajaxTable']);
        Route::post('/input', [AssignedOrganisationController::class, 'input']);
        Route::post('/delete/{id}', [AssignedOrganisationController::class, 'delete']);
    });
});
